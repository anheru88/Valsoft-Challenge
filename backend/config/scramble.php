...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Library management API. Errors share one envelope: '
            .'{"error": {"code", "message", "details", "trace_id"}}. A 422 means the input is '
            .'malformed, a 409 means the input is fine and the business state disagrees. '
            .'Every response carries an X-Request-Id header, which echoes an inbound one.',
    ],
    ...
    'security_strategy' => [
        ...
        [
            // Sanctum bearer tokens (FR-AUTH-1). Routes without this middleware —
            // login and register — are documented as public.
